...
public class ArcView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mInnerCircleRadius = (int) a.getDimension(R.styleable.ArcView_innerCircleRadius, ArcViewUtil.dip2px(getContext(), 50));
        ...
        mCircleTextSize = a.getDimension(R.styleable.ArcView_circleTextSize, ArcViewUtil.sp2px(getContext(), 18));
        mOuterCircleRadius = (int) a.getDimension(R.styleable.ArcView_outerCircleRadius, ArcViewUtil.dip2px(getContext(), 100));
    ...
    private void drawText(Canvas canvas) {
        ...
        mTextPaint.setTextSize(ArcViewUtil.dip2px(getContext(), 18));
    ...
    public void setCircleTextSize(float dp) {
        mCircleTextSize = ArcViewUtil.dip2px(getContext(), dp);
    }
